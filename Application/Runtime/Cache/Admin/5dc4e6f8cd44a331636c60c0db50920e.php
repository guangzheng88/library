...
<head>
    ...
    <script type="text/javascript">
        function openNew(){
            var options = {
                contentUrl:'<?php echo U("Permissions/detail");?>',
                confirmUrl:'<?php echo U("Permissions/addRole");?>',
                title:'添加权限',
                formName:'form'
            };
            TPA.dialog(options);
        ...
        function edit( id ){
            var options = {
                contentUrl:'<?php echo U("Permissions/detail");?>',
                contentData:{id:id},
                confirmUrl:'<?php echo U("Permissions/updateRole");?>',
                confirmData:{id:id},
                title:'修改权限',
                formName:'form'
            };
        ...
        function enabledSwitch( id, status ){
            var options = {
                idValue:id,
                switchValue:status,
                confirmUrl:'<?php echo U("Permissions/serviceEnabledSwitch");?>'
            };
...
<div class="col-sm-3 col-md-2 sidebar">
    ...
    <ol class="breadcrumb">
        <li><a href="/">首页</a></li>
        <li class="active"><a href="<?php echo U('Permissions/roleList');?>">权限列表</a></li>
    </ol>
