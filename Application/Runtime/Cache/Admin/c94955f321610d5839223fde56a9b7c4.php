...
<head>
    ...
    <script type="text/javascript">
        function openNew(){
            var options = {
                contentUrl:'<?php echo U("Role/detail");?>',
                confirmUrl:'<?php echo U("Role/addRole");?>',
                title:'添加角色',
                formName:'form'
            };
            TPA.dialog(options);
        ...
        function edit( id ){
            var options = {
                contentUrl:'<?php echo U("Role/detail");?>',
                contentData:{id:id},
                confirmUrl:'<?php echo U("Role/updateRole");?>',
                confirmData:{id:id},
                title:'修改角色',
                formName:'form'
            };
...
<div class="col-sm-3 col-md-2 sidebar">
    ...
    <ol class="breadcrumb">
        <li><a href="/">首页</a></li>
        <li class="active"><a href="<?php echo U('Role/roleList');?>">角色列表</a></li>
    </ol>
        ...
        <table class="table table-striped table-hover">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="<?php if(empty($item["enabled"])): ?>danger<?php endif; ?>">
                    ...
                    <td>
                        ...
                        <a href="javascript:;" title="删除" onclick="deleteRole(<?php echo ($item["id"]); ?>)"><span class="glyphicon glyphicon-off text-danger" aria-hidden="true"></span></a>
                        <!-- <a href="<?php echo U('module/assignPower',['id' => $item['id']]);?>" title="分配角色"><span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span></a> -->
                    </td>
